...
export class AMOscillator extends Instrument {
    ...
    constructor(volume?: number, frequency?: number, detune?: number) {
        ...
        super(NodeName.AMOscillator, InstrumentType.MONO)
        ...
        this.props.set('volume', { type: ParamType.KNOB, name: 'Volume', get: () => this.volume, set: (v:number) => this.volume = v, min: 0, max: 1, step: 0.01, precision: 2, groupID: 0 })
        ...
        this.props.set('attack', { type: ParamType.KNOB, name: 'Attack', get: () => this.attack, set: (v:number) => this.attack = v, min: 0.01, max: 5, step: 0.01, precision: 2, groupID: 4 })
