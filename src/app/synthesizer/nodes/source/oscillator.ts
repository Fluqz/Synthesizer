...
export class Oscillator extends Instrument {
    ...
    constructor(volume?: number, frequency?: number, detune?: number) {
        ...
        super(NodeName.Oscillator, InstrumentType.MONO)
        ...
        this.props.set('detune', { type: ParamType.KNOB, name: 'Detune', get: () => { return this.detune }, set: (v) => this.detune = v, min: -1000, max: 1000, step: 0.01, precision: 2, groupID: 2 })
        this.props.set('phase', { type: ParamType.KNOB, name: 'Phase', get: () => this.phase, set: (v:number) => this.phase = v, min: 0, max: 100, step: 0.01, precision: 2, groupID: 2 })
